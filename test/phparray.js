...
describe('Wrapped PHP arrays accessed from JavaScript', function() {
  var php = require('../');
  var defaultCode = [
  ...
  describe('should set', function() {
    ...
    it('string properties via set', function() {
      return test(function(a, b, c) {
        ...
        a.length.should.equal(4);  // String properties don't affect length
  ...
  describe('should delete', function() {
    ...
    it('indexed properties (numeric)', function() {
      return test(function(a, b, c) {
        delete a[3];
        a.length.should.equal(4);  // Note that array is not reindexed.
        ...
        c.length.should.equal(2);  // Note that array is not reindexed.
        c.size().should.equal(1);
      });
    });
    it('indexed properties (string)', function() {
